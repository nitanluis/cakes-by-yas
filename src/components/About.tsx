  ...
  return (
    <section ref={sectionRef} id="about" className="px-6 md:px-12 pt-8 pb-2 md:pt-16 md:pb-8 w-full flex justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-[1000px] flex flex-col items-center text-center relative z-10">
        <h2 className="about-animate typo-h2 mb-10">
          Our Story
        </h2>
        
        <p className="about-animate typo-body md:text-[16px] leading-[2] mb-12 px-4 md:px-12">
        ...
        <p className="about-animate typo-intro text-2xl md:text-3xl px-8 md:px-16" style={{ color: "var(--color-primary)", opacity: 1 }}>
