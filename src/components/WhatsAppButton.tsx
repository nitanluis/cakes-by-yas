  ...
  return (
    <div ref={containerRef} className="fixed bottom-6 right-6 lg:bottom-8 lg:right-8 z-50 flex flex-col items-end">
      ...
      <button
        ...
        className={`px-6 py-3.5 md:py-4 rounded-[6px] flex items-center gap-3 transition-all duration-500 relative overflow-hidden group hover:scale-[1.03] active:scale-95 ${!isOpen ? 'shadow-[0_8px_25px_rgba(234,103,125,0.4)] hover:shadow-[0_12px_30px_rgba(234,103,125,0.6)]' : 'shadow-lg'}`}
        style={{ 
