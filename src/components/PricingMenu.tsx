          ...
          {MENU_CATEGORIES.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex-1 py-3 px-4 md:py-3.5 text-sm md:text-base font-semibold rounded-xl md:rounded-full transition-all duration-300 active:scale-95 ${
                  isActive 
                            ...
                            <div className="flex flex-col gap-2">
                              {item.sizes!.map((size, sIdx) => (
                                <button
                                  ...
                                  className={`flex items-center justify-between p-3 min-h-[48px] rounded-xl border text-left transition-colors duration-150 touch-manipulation select-none ${
                            ...
                            <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:gap-2">
                              {FILLINGS.map((fill, fIdx) => (
                                <button
                                  ...
                                  className={`w-full sm:w-auto px-4 py-3 sm:py-2 min-h-[48px] sm:min-h-0 rounded-xl sm:rounded-full text-sm font-medium border transition-colors duration-150 touch-manipulation select-none text-left sm:text-center ${
                                    currentFilling === fill
                            ...
                            <>
                              ...
                              <div className="flex flex-col sm:flex-row gap-3">
                                <a
                                  ...
                                  className="flex-1 flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl font-bold text-white touch-manipulation"
