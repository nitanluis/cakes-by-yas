        ...
        <div ref={containerRef} className="w-full max-w-none xl:max-w-[1920px] px-0 md:px-8 flex flex-col items-center">
          ...
          <div className="mt-12 md:mt-16 text-center flex flex-col items-center">
            ...
            <button
              ...
              className="group relative inline-flex items-center gap-3 px-7 sm:px-8 py-3.5 sm:py-4 bg-[var(--color-text)] text-white font-semibold uppercase tracking-widest text-xs sm:text-sm rounded-md overflow-hidden transition-all duration-500 hover:scale-105 shadow-md hover:shadow-xl"
            >
            ...
            <div className="w-full md:w-2/5 p-6 md:p-10 flex flex-col h-full bg-white overflow-y-auto">
              ...
              <div className="mt-auto space-y-3 pt-6 border-t border-gray-100">
                ...
                <button 
                  ...
                  className="w-full flex items-center justify-center gap-3 py-3.5 px-6 rounded-md bg-[#25D366] hover:bg-[#1EBE5D] text-white font-medium transition-colors shadow-sm"
                >
                ...
                <button 
                  ...
                  className="w-full flex items-center justify-center gap-3 py-3.5 px-6 rounded-md bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium transition-colors shadow-sm"
                >
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
