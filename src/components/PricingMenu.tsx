                      ...
                      <div className="p-5 md:p-6 flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-2">
                              {item.sizes!.map((size, sIdx) => (
                                <button
                                  ...
                                  className={`flex items-center justify-between p-3 min-h-[48px] rounded-[6px] border text-left transition-colors duration-150 touch-manipulation select-none ${
                            ...
                            <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:gap-2">
                              {FILLINGS.map((fill, fIdx) => (
                                <button
                                  ...
                                  className={`w-full sm:w-auto px-4 py-3 sm:py-2 min-h-[48px] sm:min-h-0 rounded-[6px] text-sm font-medium border transition-colors duration-150 touch-manipulation select-none text-left sm:text-center ${
                                    currentFilling === fill
                        ...
                        <div className="pt-4 mt-2 border-t border-[rgba(0,0,0,0.05)] flex flex-col gap-4">
                          {isReadyToOrder ? (
                            <>
                              ...
                              <div className="flex flex-col sm:flex-row gap-3">
                                <a
                                  ...
                                  className="flex-1 flex items-center justify-center gap-2 py-3.5 px-4 rounded-[6px] font-bold text-white touch-manipulation"
                            ...
                            <div className="w-full py-3.5 px-4 rounded-[6px] font-bold text-center text-white opacity-50 cursor-not-allowed bg-[var(--color-primary)]">
