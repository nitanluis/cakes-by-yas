...
const MENU_ITEMS = [
  ...
  { id: 11, title: "Flan Napolitano", desc: "El postre tradicional con el toque especial de la casa.", price: "$45" },
  { id: 12, title: "Number Cake", desc: "Pastel en forma de número con galleta y frutas.", price: "$70+" },
  { id: 13, title: "Custom Masterpiece", desc: "Tú lo imaginas, nosotros lo creamos a medida.", price: "Cotizar" },
];
        ...
        >
          ...
          >
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-[var(--color-bg)]">
              ...
              {/* WhatsApp CTA Button */}
              <a
                href={`https://wa.me/18626680038?text=Hola%20Yas!%20Me%20encantaría%20ordenar%20el%20pastel:%20*${encodeURIComponent(selectedImage.title)}*.%0A%0A_Precio%20base:%20${encodeURIComponent(selectedImage.price)}_%0ADetalle:%20${encodeURIComponent(selectedImage.desc)}`}
                target="_blank"
