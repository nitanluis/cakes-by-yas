    ...
    <section id="pasteles" className="py-16 sm:py-24 px-4">
      <div className="max-w-[1280px] mx-auto">
        ...
        >
          ...
          <div
            className="bento-block glass-panel relative overflow-hidden !rounded-3xl p-6 sm:p-8 flex flex-col justify-between"
          >
            <div>
