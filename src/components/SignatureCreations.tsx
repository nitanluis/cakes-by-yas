...
export default function SignatureCreations() {
  ...
  return (
    <>
      <section id="pasteles" className="w-full flex justify-center px-4 sm:px-6 md:px-12 py-16 md:py-24 bg-[var(--color-bg)]">
        <div ref={containerRef} className="w-full max-w-none xl:max-w-[1920px] px-0 md:px-8 flex flex-col items-center">
          ...
          <div className="mt-12 md:mt-16 text-center flex flex-col items-center">
            ...
            <button
              ...
              className="group relative inline-flex items-center gap-3 px-7 sm:px-8 py-3.5 sm:py-4 bg-[var(--color-text)] text-white font-semibold uppercase tracking-widest text-xs sm:text-sm rounded-full overflow-hidden transition-all duration-500 hover:scale-105 shadow-md hover:shadow-xl"
            >
              <span className="relative z-10">Request Custom Design</span>
              <svg
                className="relative z-10 w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-500 group-hover:translate-x-1"
                viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
              >
                <path d="M5 12h14M12 5l7 7-7 7" />
              </svg>
              <div className="absolute inset-0 bg-[var(--color-primary)] translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-[cubic-bezier(0.25,0.46,0.45,0.94)]" />
            </button>
          </div>
            ...
            <div className="w-full md:w-2/5 p-6 md:p-10 flex flex-col h-full bg-white overflow-y-auto">
              ...
              <div className="mt-auto space-y-3 pt-6 border-t border-gray-100">
                ...
                <button 
                  ...
                  className="w-full flex items-center justify-center gap-3 py-3.5 px-6 rounded-full bg-[#25D366] hover:bg-[#1EBE5D] text-white font-medium transition-colors shadow-sm"
                >
                ...
                <button 
                  ...
                  className="w-full flex items-center justify-center gap-3 py-3.5 px-6 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium transition-colors shadow-sm"
                >
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
