...
export default function Contact() {
  ...
  return (
    <section id="contacto" className="px-6 md:px-12 pt-4 pb-16 md:pt-8 md:pb-24 w-full flex justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-[800px] flex flex-col items-center text-center relative z-10">
        ...
        <p className="typo-body text-sm md:text-base mb-12 w-full max-w-2xl break-words whitespace-normal">
        ...
        <div className="flex flex-col md:flex-row gap-6 w-full max-w-[650px] justify-center items-center">
          ...
          <a 
            ...
            onClick={handleSMS}
            className="w-full md:w-auto min-w-[180px] flex justify-center items-center gap-3 py-4 md:py-5 px-6 rounded-[6px] bg-white/50 backdrop-blur-md shadow-soft transition-all duration-300 hover:shadow-medium hover:-translate-y-1 group border border-white/60"
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--color-text-muted)] group-hover:text-[var(--color-primary)] transition-colors pointer-events-none">
              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10z" className="pointer-events-none"></path>
            </svg>
            <span className="typo-button text-[var(--color-text)] group-hover:text-[var(--color-primary)] transition-colors pointer-events-none">
              Text SMS
            </span>
          </a>
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="pointer-events-none">
            ...
            <span className="typo-button pointer-events-none">
              WhatsApp
            </span>
          </a>
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--color-text-muted)] group-hover:text-[var(--color-primary)] transition-colors pointer-events-none">
              <rect x="2" y="2" width="20" height="20" rx="5" ry="5" className="pointer-events-none"></rect>
              <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" className="pointer-events-none"></path>
              <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" className="pointer-events-none"></line>
            </svg>
            <span className="typo-button text-[var(--color-text)] group-hover:text-[var(--color-primary)] transition-colors pointer-events-none">
              Instagram
            </span>
