        ...
        <div ref={containerRef} className="w-full max-w-none xl:max-w-[1920px] px-0 md:px-8 flex flex-col items-center">
          ...
          <div className="mt-12 md:mt-16 text-center flex flex-col items-center">
            ...
            <button
              ...
              className="group relative inline-flex items-center gap-3 px-7 sm:px-8 py-3.5 sm:py-4 bg-[var(--color-text)] text-white font-semibold uppercase tracking-widest text-xs sm:text-sm rounded-[6px] overflow-hidden transition-all duration-500 hover:scale-105 shadow-md hover:shadow-xl"
            >
